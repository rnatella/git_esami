...
parser.add_argument('-d', '--delay', type=int, default=5, help="Delay (in seconds) between API calls")
...
if server_choice == "gitlab":
	...
	if not os.path.exists('./python-gitea.cfg'):
		print("Unable to find python-gitlab.cfg")
		sys.exit(1)


print("GitLab authentication" if server_choice == "gitlab" else "Gitea authentication")
